		...
		<div class="container">
            ...
            <div class="header-info">
                ...
                <div class="header-right login">
                    ...
                    <div id="loginBox">
                        <form id="loginForm" method="post" action="denglu.php">
                            <fieldset id="body">
                                <fieldset>
		...
		<div class="container">
			...
			<div class="cart-header">
				...
				<div class="cart-sec simpleCart_shelfItem">
					...
					<div class="cart-item-info">
						<h3><a href="#"> 3层玫瑰蛋糕 </a><span></span></h3>

						<div class="delivery">
							<p>服务费 : $10.00</p>
							<span>下单后1-2小时内送到 </span>
							<div class="clearfix"></div>
						</div>	
					</div>
					<div class="clearfix"></div>
			...
			<div class="cart-header2">
				...
				<div class="cart-sec simpleCart_shelfItem">
					...
					<div class="cart-item-info">
						<h3><a href="#"> 4层巧克力玫瑰蛋糕 </a><span>Pickup time:</span></h3>
			...
			<div class="cart-header3">
				...
				<div class="cart-sec simpleCart_shelfItem">
					...
					<div class="cart-item-info">
						<h3><a href="#">小清新蛋糕 </a><span>Pickup time:</span></h3>
