		...
		<div class="container">
			<div class="gallery-grids">
				<div class="col-md-8 gallery-grid glry-one">
					<a href="products.php"><img src="<?php echo $row2['picture']; ?>" class="img-responsive" alt=""/>
				...
				<div class="col-md-4 gallery-grid glry-two">
					<a href="products.php"><img src="<?php echo $row3['picture']; ?>" class="img-responsive" alt=""/>
				...
				<div class="col-md-3 gallery-grid ">
					<a href="products.php"><img src="<?php echo $row['picture']; ?>" class="img-responsive" alt="图片"/>
						<div class="gallery-info">
